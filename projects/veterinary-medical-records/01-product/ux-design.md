...
This document defines the **project-specific UX and interaction design contract** for the Veterinary Medical Records
Processing system.
...
>
> - Product meaning and strategy → [product-design.md](product-design.md)
> - Implementation details → [frontend-implementation.md](../02-tech/frontend-implementation.md) / [backend-implementation.md](../02-tech/backend-implementation.md)
...
flowchart LR
    ...
    style SYS fill:#161b22,stroke:#30363d,color:#8b949e
```
